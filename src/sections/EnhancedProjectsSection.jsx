        ...
        >
          {(projects || []).map((project, idx) => (
            ...
            >
              ...
              {/* Card Container */}
              <div className="relative backdrop-blur-lg bg-[rgba(255,255,255,0.08)] border border-[rgba(255,255,255,0.15)] rounded-2xl p-6 sm:p-8 hover:border-[#ffbd13]/50 transition-all duration-500">
                {/* Project Header */}
                <div className="mb-6">
                ...
                {/* Links */}
                <div className="flex flex-col sm:flex-row gap-3 pt-6 border-t border-[rgba(255,255,255,0.1)]">
                  {project.links?.live && project.links.live !== '#' && (
                    <motion.a
                      href={project.links.live}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center justify-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-r from-[#ffbd13] to-[#ffde76] text-[#101017] font-semibold text-sm hover:shadow-lg hover:shadow-[rgba(255,189,19,0.4)] transition-all w-full sm:w-auto"
                  ...
                  {project.links?.github && project.links.github !== '#' && (
                    <motion.a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center justify-center gap-2 px-4 py-2 rounded-lg bg-[rgba(255,255,255,0.1)] text-[#f8f7f5] font-semibold text-sm border border-[rgba(255,255,255,0.2)] hover:border-[#ffbd13] hover:bg-[rgba(255,189,19,0.1)] transition-all w-full sm:w-auto"
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                    >
